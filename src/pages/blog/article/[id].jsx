...
export default function Page({ data }) {
  ...
  return (
    <div className="m-auto flex  flex-col gap-8 px-8 text-start justify-center sm:w-[800px] sm:gap-[32px] sm:m-auto sm:flex sm:flex-col">
      ...
      <div className="h-[300px] sm:h-[462px]">
        <img
          src={data.social_image}
          alt=""
          className="rounded-xl w-full h-full bg-auto"
        />
      </div>
