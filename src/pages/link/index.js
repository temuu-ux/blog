  ...
  return (
    <div className="flex items-center m-auto gap-2 sm:m-auto   sm:flex sm:items-center  sm:justify-between sm:w-[1216px]">
      <div className="flex gap-1 sm:flex sm:gap-5">
        <Link href={"/blog/all"}>
          <button className="text-xs text-[#495057] cursor-pointer hover:text-[#D4A373] hover:scale-125 ease-in-out duration-300 font-bold	">
            All
          </button>
        </Link>
      ...
      <button
        className="text-xs text-[#495057] font-bold cursor-pointer hover:text-[#D4A373] hover:scale-125 ease-in-out duration-300 flex items-center "
